...
import { getLiveGame, getSettings } from '../data/store.js'
      ...
      <header className="sticky top-0 z-30 border-b border-white/5 backdrop-blur-md" style={{background:'rgba(5,5,16,0.85)'}}>
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between gap-3">
          <Link to="/" onClick={close} className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="font-display text-neon-cyan text-xs font-bold tracking-widest hidden sm:block" style={{textShadow:'0 0 12px rgba(0,245,255,0.5)'}}>
              {settings.leagueName || 'Poker League'}
            </span>
          </Link>
